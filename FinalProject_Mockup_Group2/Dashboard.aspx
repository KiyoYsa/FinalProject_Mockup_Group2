...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="portal-wrapper">
        ...
        <div class="main-stage">
            <h2 style="color: #7A1C1C;">
                <asp:Literal ID="litTabHeader" runat="server" /></h2>

            <div class="add-section">
                <h4 style="margin: 0 0 15px 0; color: #BD8232;">+ Create New
                    <asp:Literal ID="litAddLabel" runat="server" /></h4>

                <asp:MultiView ID="mvAddForms" runat="server">
                    <%-- View for Crafts: Matches Crafts Table --%>
                    <asp:View ID="vwAddCraft" runat="server">
                        <div class="form-row">
                            <div class="form-item">
                                <label>Craft Name</label>
                                <asp:TextBox ID="txtCName" runat="server" CssClass="form-ctrl" />
                            </div>
                            <div class="form-item">
                                <label>Description</label>
                                <asp:TextBox ID="txtCDesc" runat="server" CssClass="form-ctrl" />
                            </div>
                            <div class="form-item">
                                <label>Category</label>
                                <asp:DropDownList ID="ddlCCat" runat="server" CssClass="form-ctrl" DataTextField="CategoryName" DataValueField="CategoryID" />
                            </div>
                            <div class="form-item">
                                <label>Pattern</label>
                                <asp:DropDownList ID="ddlCPat" runat="server" CssClass="form-ctrl" DataTextField="PatternName" DataValueField="PatternID" />
                            </div>
                    ...
                    <%-- View for Artisans: Matches Artisans Table --%>
                    <asp:View ID="vwAddArtisan" runat="server">
                        <div class="form-row">
                            <div class="form-item">
                                <label>Full Name</label>
                                <asp:TextBox ID="txtAName" runat="server" CssClass="form-ctrl" />
                            </div>
                            <div class="form-item">
                                <label>Bio</label>
                                <asp:TextBox ID="txtABio" runat="server" CssClass="form-ctrl" TextMode="MultiLine" Rows="1" />
                            </div>
                            <div class="form-item">
                                <label>Location</label>
                                <asp:TextBox ID="txtALocation" runat="server" CssClass="form-ctrl" placeholder="Lake Sebu" />
                            </div>
                    ...
                    <%-- View for Patterns: Matches Patterns Table --%>
                    <asp:View ID="vwAddPattern" runat="server">
                        <div class="form-row">
                            <div class="form-item">
                                <label>Pattern Name</label>
                                <asp:TextBox ID="txtPName" runat="server" CssClass="form-ctrl" />
                            </div>
                            <div class="form-item">
                                <label>Spiritual Meaning</label>
                                <asp:TextBox ID="txtPSpiritual" runat="server" CssClass="form-ctrl" />
                            </div>
                            <div class="form-item">
                                <label>History</label>
                                <asp:TextBox ID="txtPHistory" runat="server" CssClass="form-ctrl" />
                            </div>
                    ...
                    <%-- View for Categories: Matches Categories Table --%>
                    <asp:View ID="vwAddCategory" runat="server">
                        <div class="form-row">
                            <div class="form-item">
                                <label>Category Name</label>
                                <asp:TextBox ID="txtCatName" runat="server" CssClass="form-ctrl" />
                            </div>
                            <asp:Button runat="server" ID="btnAddCat" Text="Add Category" OnClick="btnAddCategory_Click" CssClass="nav-btn active" Style="width: auto; height: 36px;" />
                        </div>
                    </asp:View>

                    <%-- View for Users: Matches Users Table --%>
                    <asp:View ID="vwAddUser" runat="server">
                        <div class="form-row">
                            <div class="form-item">
                                <label>Username</label>
                                <asp:TextBox ID="txtUName" runat="server" CssClass="form-ctrl" />
                            </div>
                            <div class="form-item">
                                <label>Password</label>
                                <asp:TextBox ID="txtUPass" runat="server" CssClass="form-ctrl" TextMode="Password" />
                            </div>
                            <div class="form-item">
                                <label>Role</label>
                                <asp:DropDownList ID="ddlURole" runat="server" CssClass="form-ctrl">
                                    <asp:ListItem Text="Dreamweaver" Value="Dreamweaver" />
                                    <asp:ListItem Text="Admin" Value="Admin" />
                                </asp:DropDownList>
                            </div>
                            <asp:Button runat="server" ID="btnAddUser" Text="Add User" OnClick="btnAddUser_Click" CssClass="nav-btn active" Style="width: auto; height: 36px;" />
                        </div>
                    </asp:View>
                </asp:MultiView>
            </div>
