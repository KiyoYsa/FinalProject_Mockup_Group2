<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserLogin.aspx.cs" Inherits="FinalProject_Mockup_Group2.UserLogin" %>
    ...
    <form runat="server">
        <div class="login-container">
            ...
            <div class="login-form">
                ...
                <asp:Button ID="btnLogin" runat="server" Text="Login" CssClass="login-btn" /> <!-- add OnClick="btnLogin_Click" -->
