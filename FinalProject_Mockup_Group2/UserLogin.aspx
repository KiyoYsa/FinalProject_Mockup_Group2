<%@ Page Title="Dreamweaver Portal" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UserLogin.aspx.cs" Inherits="FinalProject_Mockup_Group2.UserLogin" %>
    ...
    <script>
        function togglePassword() {
            ...
            if (pass.type === "password") {
                ...
                pass.type = "password";
                eyeIcon.setAttribute("d", closedEye);
            }
        }
    </script>
        ...
        <div class="login-container">
            ...
            <div class="login-image">
                <div class="login-image-text">
                    <asp:Literal ID="litSidebarText" runat="server" Text="Dreamweavers Collective" />
                </div>
            </div>
            ...
            <div class="login-form">
                ...
                <asp:Panel ID="pnlLogin" runat="server">
                    ...
                    <div class="input-group">
                        ...
                        <svg class="toggle-password" onclick="togglePassword()" viewBox="0 -960 960 960" fill="#7A1C1C">
                ...
                <asp:Panel ID="pnlDashboard" runat="server" Visible="false">
                    <div class="login-title" style="margin-bottom:10px;">B'long, <asp:Literal ID="litUsername" runat="server" />!</div>
                    <p style="text-align:center; color:#555; margin-bottom:20px;">Role: <asp:Literal ID="litRole" runat="server" /></p>
                    
                    <asp:Button ID="btnEditProfile" runat="server" Text="Manage Account" CssClass="login-btn" OnClick="btnOpenEdit_Click" />
                    <asp:Button ID="btnLogout" runat="server" Text="Logout" CssClass="login-btn" OnClick="btnLogout_Click" style="background:#444; margin-top:10px;" />
                </asp:Panel>

            </div>
        </div>

        <asp:Panel ID="pnlEditModal" runat="server" Visible="false" CssClass="modal-overlay" style="display:flex;">
            <div class="modal-content" style="max-width:400px; border-top: 6px solid #8C0000;">
                <span class="close-btn" style="top:5px; right:15px;" onclick="location.reload();">×</span>
                <h2 style="color:#7B160E; margin-bottom:20px;">Update Credentials</h2>
                
                <p style="margin-bottom:5px; font-weight:bold;">Username:</p>
                <asp:TextBox ID="txtEditUsername" runat="server" CssClass="login-input" style="padding:10px;" />
                
                <p style="margin-top:15px; margin-bottom:5px; font-weight:bold;">New Password:</p>
                <asp:TextBox ID="txtEditPass" runat="server" CssClass="login-input" TextMode="Password" style="padding:10px;" />
                
                <div style="margin-top:25px; display:flex; gap:10px;">
                    <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btn-read" OnClick="btnSave_Click" style="flex:1; cursor:pointer;" />
                    <asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="btn-read" OnClick="btnCancel_Click" style="flex:1; background:#444; cursor:pointer;" />
                </div>
            </div>
        </asp:Panel>
    </div>
